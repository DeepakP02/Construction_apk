...
const styles = StyleSheet.create({
    ...
    splitList: { flex: 1, backgroundColor: COLORS.background, borderRightWidth: 1, borderRightColor: '#E2E8F0' },
    splitMap: { flex: 1.5 },
    header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: SPACING.m, paddingVertical: 14, backgroundColor: COLORS.card, borderBottomWidth: 1, borderBottomColor: '#E2E8F0' },
    backBtn: { width: 36, height: 36, borderRadius: 10, backgroundColor: COLORS.surfaceSecondary, alignItems: 'center', justifyContent: 'center', marginRight: 10 },
    headerActions: { flexDirection: 'row', alignItems: 'center', gap: SPACING.s },
    ...
    subtitle: { fontSize: 11, fontWeight: '700', color: COLORS.textSecondary, marginTop: 1 },
    search: { margin: 14, backgroundColor: COLORS.card, borderRadius: SIZES.radiusBtn, borderWidth: 1, borderColor: COLORS.border, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center' },
    searchInput: { flex: 1, marginLeft: 8, height: 44, fontWeight: '700', color: COLORS.textPrimary },
    loaderWrap: { flex: 1, justifyContent: 'center', alignItems: 'center', gap: SPACING.sm },
    loaderText: { color: COLORS.textSecondary, fontWeight: '700' },
    listContent: { paddingHorizontal: 14, paddingBottom: 24 },
    card: { backgroundColor: COLORS.card, borderWidth: 1, borderColor: COLORS.border, borderRadius: SIZES.radiusBtn, padding: 12, marginBottom: 10 },
    rowTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    nameWrap: { flex: 1, marginRight: 10 },
    name: { fontSize: 14, fontWeight: '900', color: COLORS.textPrimary },
    project: { fontSize: 11, fontWeight: '700', color: COLORS.textSecondary, marginTop: 2 },
    ...
    meta: { marginTop: 8, fontSize: 11, fontWeight: '700', color: COLORS.textSecondary },
    coords: { marginTop: 4, fontSize: 12, fontWeight: '800', color: COLORS.textSecondary },
    actions: { marginTop: 12 },
    btn: { backgroundColor: '#2563EB', borderRadius: SIZES.radiusBtn, paddingHorizontal: 14, paddingVertical: 12, flexDirection: 'row', alignItems: 'center', gap: SPACING.s, justifyContent: 'center', minHeight: 50 },
    btnDisabled: { backgroundColor: COLORS.surfaceSecondary, borderColor: COLORS.border, borderWidth: 1, opacity: 0.6 },
    btnText: { color: COLORS.white, fontSize: 14, fontWeight: '900' },
    btnTextDisabled: { color: COLORS.textMuted },
    mapContainer: { flex: 1, overflow: 'hidden' },
    map: { width: '100%', height: '100%' },
    mapOverlay: { position: 'absolute', bottom: 20, alignSelf: 'center', backgroundColor: 'rgba(15, 23, 42, 0.9)', paddingHorizontal: SPACING.m, paddingVertical: 10, borderRadius: SIZES.radiusCard },
    mapStatusText: { color: COLORS.white, fontWeight: '900', fontSize: 12 },
    ...
    calloutContainer: { width: 200, padding: 12, backgroundColor: COLORS.card, borderRadius: SIZES.radiusBtn },
    calloutTitle: { fontSize: 14, fontWeight: '900', color: COLORS.textPrimary },
    calloutSub: { fontSize: 11, fontWeight: '700', color: COLORS.textSecondary, marginTop: 2 },
    calloutTime: { fontSize: 10, color: COLORS.textMuted, marginTop: 4 },
    calloutBtn: { marginTop: 10, backgroundColor: COLORS.surfaceSecondary, borderRadius: 8, padding: 8, alignItems: 'center' },
    calloutBtnText: { fontSize: 11, fontWeight: '900', color: '#2563EB' },
    emptyContent: { flexGrow: 1, justifyContent: 'center' },
    empty: { alignItems: 'center' },
    emptyText: { marginTop: 8, color: COLORS.textMuted, fontWeight: '700' },
});
