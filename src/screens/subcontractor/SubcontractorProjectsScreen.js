...
const styles = StyleSheet.create({
    ...
    // Header
    headerContent: { paddingHorizontal: SPACING.m, paddingTop: 10, marginBottom: 15 },
    titleText: { fontSize: 28, fontWeight: '900', color: COLORS.textPrimary, letterSpacing: -0.5 },
    subtitleRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4, gap: 6 },
    subtitleText: { fontSize: 10, fontWeight: '800', color: COLORS.textSecondary, letterSpacing: 0.5 },

    // Filters
    filterContainer: { backgroundColor: COLORS.background, paddingVertical: 8, marginHorizontal: 20, borderRadius: SIZES.radiusCard, marginBottom: 15 },
    ...
    filterTabText: { fontSize: 9, fontWeight: '900', color: COLORS.textSecondary },
    filterTabTextActive: { color: COLORS.white },

    // Search
    searchWrapper: { paddingHorizontal: SPACING.m, marginBottom: SPACING.m },
    searchContainer: { 
        flexDirection: 'row', 
        alignItems: 'center', 
    ...
    searchInput: { flex: 1, marginLeft: 10, fontSize: 14, fontWeight: '600', color: COLORS.textPrimary },

    // List
    listContainer: { paddingHorizontal: SPACING.m, paddingBottom: 100 },
    ...
    manageLabel: { fontSize: 9, fontWeight: '800', color: COLORS.textMuted, marginBottom: 4 },
    ...
    jobTitle: { fontSize: 20, fontWeight: '900', color: COLORS.textPrimary, marginBottom: 6 },
    locationContainer: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 15 },
    locationText: { fontSize: 12, fontWeight: '700', color: COLORS.textSecondary },

    progressSection: { marginBottom: 25 },
    progressLabelRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
    progressLabel: { fontSize: 9, fontWeight: '900', color: COLORS.textMuted },
    progressPercent: { fontSize: 10, fontWeight: '900', color: COLORS.textPrimary },
    progressBarBg: { height: 4, backgroundColor: COLORS.surfaceSecondary, borderRadius: 2, overflow: 'hidden' },
    ...
    viewTasksBtnText: { color: COLORS.white, fontSize: 13, fontWeight: '900', letterSpacing: 1 },

    emptyState: { alignItems: 'center', paddingVertical: 60 },
    emptyText: { marginTop: SPACING.m, fontSize: 14, color: COLORS.textMuted, fontWeight: '700' }
});
