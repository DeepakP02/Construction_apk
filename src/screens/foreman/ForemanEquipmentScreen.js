...
const ForemanEquipmentScreen = () => {
    return (
        <View style={styles.screen}>
            <StatusBar barStyle="dark-content" />
            <WorkerHeader title="Site Equipment" hideSearch />

            <View style={styles.emptyContainer}>
                <MaterialCommunityIcons name="crane" size={80} color="#E2E8F0" />
                <Text style={styles.emptyTitle}>Equipment Logs</Text>
...
export default ForemanEquipmentScreen;
