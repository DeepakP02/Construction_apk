...
const TradeManagementScreen = () => {
    return (
        <View style={styles.screen}>
            ...
            <WorkerHeader title="Trade Partners" hideSearch />

            <View style={styles.emptyContainer}>
                <MaterialCommunityIcons name="account-hard-hat" size={80} color="#E2E8F0" />
                <Text style={styles.emptyTitle}>Trade Partners</Text>
