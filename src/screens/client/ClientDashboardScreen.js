...
const styles = StyleSheet.create({
    ...
    loadHint: { marginTop: 12, fontWeight: '700', color: COLORS.textSecondary, fontSize: 13 },
    scrollContent: { paddingHorizontal: SPACING.m, paddingTop: 10 },
    welcome: { fontSize: 22, fontWeight: '900', color: COLORS.textPrimary, marginBottom: 6 },
    welcomeName: { color: '#2563EB' },
    welcomeSub: { fontSize: 13, fontWeight: '600', color: COLORS.textSecondary, marginBottom: SPACING.m, lineHeight: 18 },
    mainCard: {
    ...
    bigPercent: { fontSize: 36, fontWeight: '900', color: COLORS.textPrimary, letterSpacing: -1.5 },
    progressNameBox: { marginLeft: 15, flex: 1 },
    projectNameText: { fontSize: 16, fontWeight: '800', color: COLORS.textPrimary },
    progressLabel: { fontSize: 12, fontWeight: '600', color: COLORS.textMuted, marginTop: 2 },
    progressBarWrapper: {
        height: 8,
    ...
    cardDivider: { height: 1, backgroundColor: COLORS.surfaceSecondary, width: '100%', marginBottom: 15 },
    updateSection: { marginBottom: SPACING.m },
    updateMeta: { flexDirection: 'row', alignItems: 'center', marginBottom: 6 },
    updateDate: { fontSize: 12, fontWeight: '800', color: COLORS.textSecondary },
    ...
    updateDesc: { fontSize: 14, color: COLORS.textSecondary, lineHeight: 20, fontWeight: '600' },
    rowActions: { flexDirection: 'row', gap: 10, alignItems: 'stretch' },
    compactActionBtn: { flex: 1, borderRadius: SIZES.radiusBtn, overflow: 'hidden', elevation: 3 },
    outlineMini: {
        flexDirection: 'row',
        alignItems: 'center',
    ...
    btnGradient: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 12, gap: SPACING.s },
    ...
    sectionTitleCompact: { fontSize: 15, fontWeight: '900', color: COLORS.textPrimary },
    linkText: { fontSize: 12, fontWeight: '800', color: COLORS.primaryAccent },
    mutedBox: { fontSize: 13, fontWeight: '600', color: COLORS.textMuted, marginBottom: 14, paddingHorizontal: 4 },
    galleryScrollCompact: { marginHorizontal: -16, paddingHorizontal: SPACING.m },
    galleryItemCompact: {
        marginRight: 12,
        width: 120,
        height: 120,
    ...
    siteLabelText: { color: COLORS.white, fontSize: 10, fontWeight: '900' },
    docItemCompact: {
        flexDirection: 'row',
        alignItems: 'center',
        backgroundColor: COLORS.card,
    ...
    docTitleCompact: { fontSize: 14, fontWeight: '800', color: COLORS.textPrimary },
    docMetaCompact: { fontSize: 11, color: COLORS.textMuted, fontWeight: '700', marginTop: 2 },
    ...
    viewAllVaultTextCompact: { fontSize: 13, fontWeight: '800', color: COLORS.textSecondary },
});
